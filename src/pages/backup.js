      ...
      <div className="h-screen flowers">
          ...
          <div className="flex flex-col gap-[5px] p-[1%] language-button">
            {lngs.map((lng, i) => {
              ...
              className="text-white wine-to-coral w-[150px] rounded-lg">{native}</button>;
            })}
          </div>
              ...
              <div className="flex flex-col gap-[18px] items-center py-[10%]">
                  ...
                  <div className="flex flex-col self-center">
                    ...
                    <div className="container">
                      <div className="inputfield-below bg-paleblue"/>
                      ...
                      <div className="inputfield-above bg-white"/>
                    </div>
                  </div>
                  ...
                  <Link href={{pathname:"/auth", query:
                    ...
                    <button className="mt-[20px] wine-to-coral w-[240px] rounded-lg
                  text-white self-center" onClick={sendCreds}>{t('submit')}</button>
                  </Link>
              </div>
          </div>
      </div>
